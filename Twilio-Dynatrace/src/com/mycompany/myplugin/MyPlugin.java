...
public class MyPlugin implements ActionV2 {

	private static final Logger log = Logger.getLogger(MyPlugin.class.getName());
	
	//public static final String ACCOUNT_SID = "AC92d5cb403630cf050ac1986994b60e91";
	//public static final String AUTH_TOKEN = "97fb3a0e76253b7062275cd64663c13d";
	
	//public static final String ACCOUNT_SID = "AC120618d0705935f61de0333d1b16717c";
	//public static final String AUTH_TOKEN = "411a9d6716a0b799566fae961fbfce97";
	
	
	private static final String ACCOUNT_SID_1 = "ACCOUNT_SID";
	private static final String AUTH_TOKEN_1 = "AUTH_TOKEN";
	private static final String FROM_PH_NUM_1 = "from_PHONE_NUM";
	private static final String TO_PH_NUM_1 = "t_PHONE_NUM";
	...
	public Status setup(ActionEnvironment env) throws Exception {
		...
		ACCOUNT_SID = env.getConfigString(ACCOUNT_SID_1);
		AUTH_TOKEN =  env.getConfigString(AUTH_TOKEN_1);
		FROM_PHONENUMBER = 	env.getConfigString(FROM_PH_NUM_1);
		TO_PHONENUMBER = env.getConfigString(TO_PH_NUM_1);
	...
	public Status execute(ActionEnvironment env) throws Exception {
		...
		log.info("TO PH Number is "+TO_PHONENUMBER);
		
		String[] ALL_TO_PHONE = TO_PHONENUMBER.split("\\s*,\\s*");
		
			String shrtDesc ="";
			for (Incident incident : incidents) {
				shrtDesc = incident.getMessage();
			
			
			for( int i=0; i<ALL_TO_PHONE.length; i++) {
			//for (String ph-num : ALL_TO_PHONE) {				
			
			Message message = Message.creator(new PhoneNumber(ALL_TO_PHONE[i]),
			new PhoneNumber(FROM_PHONENUMBER), shrtDesc).create();			
